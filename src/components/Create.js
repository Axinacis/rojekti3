...
class Create extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.post('http://localhost:3000/books', {isbn, title, author, description, published_date, publisher})
            .then((result) => {
                        ...
                        <form onSubmit={this.onSubmit}>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="isbn" value={isbn}
                                       onChange={this.onChange} placeholder="ISBN"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="published_date" value={published_date}
                                       onChange={this.onChange} placeholder="Published Date"/>
                            </div>
                            <div class="form-group">
